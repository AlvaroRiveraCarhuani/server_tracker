...
var (
	...
	StyleStatusStopped = lipgloss.NewStyle().Foreground(ColorOverlay0)
	StyleStatusPaused  = lipgloss.NewStyle().Foreground(ColorYellow)
	StyleStatusCritical = lipgloss.NewStyle().Foreground(ColorRed).Bold(true)

	StyleEgressNormal = lipgloss.NewStyle().Foreground(ColorSubtext1)
...
// FormatStatus renderiza los glifos ASCII con semántica cromática estricta
